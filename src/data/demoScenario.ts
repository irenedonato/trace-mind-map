...
export const vehicleDemoEdges: GraphEdge[] = [
  ...
  { id: "vi4", source: "vcdr",  target: "vinf", type: "derivedFrom", label: "supports", confidence: 1.0,  status: "hypothesis", inferred: true, delay: 11300, step: 7,
    ...
    rationale: [
      "14 calls / 72h to a recurring unknown number",
      "Peak activity occurs prior to the Porta Susa detection",
      "Last call placed 38 minutes before the observed event",
      "Pattern consistent with pre-event coordination — not proof",
    ] },
